...
class AllProductsSection extends Component {
  state = {
    apiResponseStatus: responseStatusConstants.inProgress,
    productsList: [],
  ...
  getProducts = async () => {
    this.setState({apiResponseStatus: responseStatusConstants.inProgress})
    ...
    if (response.ok) {
      ...
      this.setState({
        ...
        apiResponseStatus: responseStatusConstants.success,
      })
    } else if (response.status === 401) {
      this.setState({apiResponseStatus: responseStatusConstants.failure})
    }
  }
  ...
  switchFunction = () => {
    ...
    switch (apiResponseStatus) {
      case responseStatusConstants.inProgress:
